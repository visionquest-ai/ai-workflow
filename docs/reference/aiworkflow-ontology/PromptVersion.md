...
Versioned instance of a Prompt with active/inactive status. Executions link here.
...
|----------|--------------|-------------|----------|
| [HAS_EXECUTION](../relations/HAS_EXECUTION.md) | [PromptExecution](../classes/PromptExecution.md) | 0-* | No |

## Incoming Relations

| Relation | Source Class | Cardinality | Required |
|----------|--------------|-------------|----------|
| [HAS_VERSION](../relations/HAS_VERSION.md) | [Prompt](../classes/Prompt.md) | 0-* | No |
