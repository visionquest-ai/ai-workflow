...
A discrete stage within a Workflow that groups related Prompts for a specific task. Steps are ordered within their parent workflow.
...
| order | Int | No | No | - |
| stepType | String | No | No | - |

## Outgoing Relations

| Relation | Target Class | Cardinality | Required |
|----------|--------------|-------------|----------|
| [HAS_PROMPT](../relations/HAS_PROMPT.md) | [Prompt](../classes/Prompt.md) | 0-* | No |

## Incoming Relations

| Relation | Source Class | Cardinality | Required |
|----------|--------------|-------------|----------|
| [HAS_STEP](../relations/HAS_STEP.md) | [Workflow](../classes/Workflow.md) | 0-* | No |
