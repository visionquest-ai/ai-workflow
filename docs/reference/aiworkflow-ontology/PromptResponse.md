...
Stored LLM response for a prompt execution. Contains the raw response data from the language model, validated against the PromptOutput JSON Schema contract.
...
| responseData | String | No | No | - |
| validationStatus | String | No | No | - |
...
|----------|--------------|-------------|----------|
| [HAS_RESPONSE](../relations/HAS_RESPONSE.md) | [PromptExecution](../classes/PromptExecution.md) | 0-* | No |
